    ...
    <div class="t1" style="height: 550px; width: 800px; opacity: 0.9; float: left; margin-left: 10px; margin-top: 10px; margin-bottom: 0px">
        <div style="width: 708px; height: 400px; margin-top: 20px">
            <div style="width: 300px; height: 500px; float: left">
                    ...
                    <div class="panel-body">
                        <div style="margin-left: 20px">
                            <div style="margin-left: 30px; margin-bottom: 2px">
                                <asp:Label ID="Lbl_nt_fnd" runat="server" Text="Data Not Matching, Try Again." ForeColor="#CC0000"></asp:Label>
                            ...
                            <div class="form-group" style="margin-top: 35px">
                                <asp:Label ID="Lbt_tId" Style="padding-right: 10px" runat="server" class="col-sm-5 control-label" Text="Ticket Id:"></asp:Label>
                                <div class="col-sm-4" style="padding-left: 0px;">
                ...
                <div class="well well-lg" style="border: 1px groove #CC99FF; height: 250px; width: 330px; margin-left: 20px;">

                    <asp:Label ID="lbl_excd" runat="server" Text="Time Exceeded" Font-Bold="True" ForeColor="#CC0000" Visible="False"></asp:Label>
